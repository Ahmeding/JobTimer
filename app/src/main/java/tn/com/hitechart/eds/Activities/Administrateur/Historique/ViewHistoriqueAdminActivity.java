package tn.com.hitechart.eds.Activities.Administrateur.Historique;
...
public class ViewHistoriqueAdminActivity extends AppCompatActivity {
    ...
    //
    private boolean isWordkedWith;
    private boolean isWorkedAt;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_historique_admin);
        ...
        spgetdate = (Spinner) findViewById(R.id.spgetdate);
        spgetuser = (Spinner) findViewById(R.id.spgetuser);
        //
        ...
        ArrayAdapter<String> arrayAdapterUser = new ArrayAdapter<String>(this, R.layout.spinner_item, userlist);
        spgetuser.setAdapter(arrayAdapterUser);
//-----------------------------------------------------------------------------------------------------------//
        tvloggeduser = (TextView) findViewById(R.id.tvloggeduser);
...
//--------------------------------------------------------------------------------
    ...
    private Rapport getcurrentRapport() {
        ...
        Rapport rapport = rapportDAO.getRapportByUserbyDate(targetUser.get_id(),
    ...
    private void setPointageValues() {
        ...
        targetUser = usersDAO.getUserByLogin(spgetuser.getSelectedItem().toString());
        //
        String selectedDate = spgetdate.getSelectedItem().toString();

        // POINTAGE
        if (pointagesDAO.getPointByUser(targetUser.get_id()) != null) {
            if (pointagesDAO.getPointByUserByDate(targetUser.get_id(), selectedDate) != null) {
                pointageToday = pointagesDAO.getPointByUserByDate(targetUser.get_id(), selectedDate);
                ...
                tvusername.setText(targetUser.getLogin());
    ...
    private void setTaskValues() {
        tasks = tasksDAO.getTachesByUser(targetUser);
...
//
    ...
    public boolean isToday(String day) {
        return datepointage.format(System.currentTimeMillis()).equals(day);
    }
}
